...
public class TrunkBendDescriptionFragment extends Fragment{


    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_trunkbend_descr, container, false);
        ...
        button.setOnClickListener( v -> {
            Intent sensorIntent = new Intent(TrunkBendDescriptionFragment.this.getActivity(), WorkoutYoutube.class);
            sensorIntent.putExtra("id", "T71NyDETwrI");
